...
public class SeeEventsClient extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_see_events_client);
...
//        }
    ...
    public void returnClick(View view) {
        startActivity(new Intent(SeeEventsClient.this, ClientHomePage.class));
        finish();
    }
